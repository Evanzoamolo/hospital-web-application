    ...
    <div class="container-fluid">
        ...
        <div class="card mt-5">
            <div class="card-body text-center mt-3 mb-3">
                <p>You have deleted a record<br>You can view details on admin dashboard</p>
                <div class="btn btn-primary mt-3 mb-3 "><a class="text-decoration-none text-white" href="admindashboard.php">close</a></div>
            </div>
