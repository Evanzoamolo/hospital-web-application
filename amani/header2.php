    ...
    <div class="container-fluid">
        <nav class="navbar  navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div class="">
                    <p>Welcome back <?php echo $_SESSION['fullName'] ;?><i class="fa-solid fa-user mx-2"></i></p>
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">Active
                            ...
                            <span class="text-white">STAFF DASHBOARD</span> </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="staffdashboard.php">
                            ...
                            <span class="text-white m-2">Admit Patients</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <hr>
                    <li class="nav-item">
                        <a class="nav-link" href="patient_discharge.php">
