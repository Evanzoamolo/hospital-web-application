                        ...
                        <div class="">
                            <div class="">
                                <form action="registeradmin.php" method="post">
                                    <div class="row">
                                       <div class="col-sm-6">
                                       <label class="mb-2 mt-2">First Name</label> <br>
                                        <input class="form-control" type="text" name="firstname">
                                       </div>
                                       <div class="col-sm-6">
                                       <label class="mb-2 mt-2">Second Name</label> <br>
                                        <input class="form-control" type="text" name="secondname">
                                       </div>
                                    </div>
                                    <div>

                                        <label class="mb-2 mt-2">Email Address</label> <br>
                                        <input class="form-control" type="email" name="emailaddress">
                                    </div>
                                    <div>

                                        <label class="mb-2 mt-2">Username</label> <br>
                                        <input class="form-control" type="text" name="username">
                                    </div>
                                    
                                    <!-- <div>

                                        <label class="mb-2 mt-2">Usertype</label> <br>
                                    ...
                                    <div>
                                        ...
                                        <label class="mb-2 mt-2">Password</label> <br>
                                        <input class="form-control" type="password" name="password"> <br>
                                    </div>

                                        <label class="mb-2 mt-2">Confirm Password</label> <br>
